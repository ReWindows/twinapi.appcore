//! Windissect-generated Rust FFI bindings for twinapi.appcore.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "1696BCDD46FC1EEE12BFAD0258C61170";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1192642877;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 20] = [116, 119, 105, 110, 97, 112, 105, 46, 97, 112, 112, 99, 111, 114, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1192642877 { return 0; }
