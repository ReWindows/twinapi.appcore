...
static constexpr wchar_t module_name[20] = {0x0074, 0x0077, 0x0069, 0x006E, 0x0061, 0x0070, 0x0069, 0x002E, 0x0061, 0x0070, 0x0070, 0x0063, 0x006F, 0x0072, 0x0065, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1192642877U || rva >= image_size) return nullptr;
return base + rva;
}
