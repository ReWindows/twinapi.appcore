# `Microsoft::BamoImpl` :: `BaseBamoConnectionImpl`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **31**.
...
|---|---|---|---|---|
| `Join` | `long` | `Method` | `Pdb` | No (PDB) |
| `LeaveLock` | `void` | `Method` | `Pdb` | No (PDB) |
| `CurrentThreadHasLock` | `bool` | `Method` | `Pdb` | No (PDB) |
| `EnterLock` | `void` | `Method` | `Pdb` | No (PDB) |
| `OnItemMessage` | `long` | `Method` | `Pdb` | No (PDB) |
| `TrackError` | `long` | `Method` | `Pdb` | No (PDB) |
| `IsPendingRemovalFromItemTable` | `bool` | `Accessor` | `Pdb` | No (PDB) |
| `TryGetItem` | `class Microsoft::BamoImpl::ConversationItem *` | `Method` | `Pdb` | No (PDB) |
| `TryGetPrincipal` | `class Microsoft::BamoImpl::BamoPrincipalImpl *` | `Method` | `Pdb` | No (PDB) |
| `BaseBamoConnectionImpl` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetBufferingMessageCallHost` | `class Microsoft::BamoImpl::BufferingMessageCallHost *` | `Accessor` | `Pdb` | No (PDB) |
| `DisableLockDrops` | `void` | `Method` | `Pdb` | No (PDB) |
| `DisconnectProxyAtShutdown` | `long` | `Method` | `Pdb` | No (PDB) |
| `EnableLockDrops` | `void` | `Method` | `Pdb` | No (PDB) |
| `Leave` | `long` | `Method` | `Pdb` | No (PDB) |
| `~BaseBamoConnectionImpl` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `DisposeProxy` | `long` | `Method` | `Pdb` | No (PDB) |
| `FreePrincipalItem` | `void` | `Method` | `Pdb` | No (PDB) |
| `FreePrincipalItemsCallback` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPeerConnected` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPeerDisconnected` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnZeroReferenceCount` | `void` | `Method` | `Pdb` | No (PDB) |
| `ProxyDisposed` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveItemIdFromConversation` | `void` | `Method` | `Pdb` | No (PDB) |
| `RequestDisposeProxy` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetBootstrapProxy` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `TryGetProxy` | `class Microsoft::BamoImpl::BamoProxyImpl *` | `Method` | `Pdb` | No (PDB) |
| `VerifyLockHeldIfOffThread` | `void` | `Method` | `Pdb` | No (PDB) |
