# `global` :: `CProjectionManagerStatics`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **49**.
...
|---|---|---|---|---|
| `InternalGetRuntimeClassNameStatic` | `unsigned short const *` | `Method` | `Pdb` | No (PDB) |
| `InternalGetTrustLevelStatic` | `enum TrustLevel` | `Method` | `Pdb` | Yes |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `ActivateInstance` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `CProjectionManagerStatics` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CProjectionManagerStatics` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetDeviceSelector` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetIids` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetIids` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetIids` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `OnProjectionDisplayAvailableChange` | `void` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `RequestStartProjectingAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `RequestStartProjectingWithPlacementAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `StartProjectingAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `StartProjectingWithDeviceInfoAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `StopProjectingAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `SwapDisplaysForViewsAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `_DoAsyncProjectionTaskImpl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_DoAsyncProjectionTaskOneCoreImpl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_DoAsyncStartProjectionUITaskImpl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_DoProjectionTaskDesktopImpl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_DoProjectionTaskImpl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_IsComposableShellEnabled` | `bool` | `Method` | `Pdb` | No (PDB) |
| `_IsOneCore` | `bool` | `Method` | `Pdb` | No (PDB) |
| `_ShouldUseAppGlomBroker` | `bool` | `Method` | `Pdb` | No (PDB) |
| `add_ProjectionDisplayAvailableChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ProjectionDisplayAvailable` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_ProjectionDisplayAvailableChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_ProjectionDisplayAvailableWnfCallback` | `long` | `Method` | `Pdb` | No (PDB) |
