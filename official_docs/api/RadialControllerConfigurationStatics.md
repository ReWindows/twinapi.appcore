# `Windows::UI::Input` :: `RadialControllerConfigurationStatics`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **44**.
...
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `RadialControllerConfigurationStatics` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~RadialControllerConfigurationStatics` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `_EnsureForAppController` | `long` | `Method` | `Pdb` | No (PDB) |
| `_EnsureForWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnApplicationControllerStateChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_AppController` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsAppControllerEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_AppController` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsAppControllerEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
