# `Windows::ApplicationModel::Core` :: `CoreApplicationViewAgileContainer`

**Category:** [Controls & Widgets](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **53**.
...
| `UninitializeLocal` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateLastLifecycleAction` | `void` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `~CoreApplicationViewAgileContainer` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `WaitForViewReady` | `void` | `Method` | `Pdb` | No (PDB) |
...
| `PrepareToActivateInternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `ActivateInternal` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `SignalViewReady` | `void` | `Method` | `Pdb` | No (PDB) |
| `CreateNewView` | `long` | `Method` | `Pdb` | No (PDB) |
| `CoreApplicationViewAgileContainer` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `RecordViewInitialization` | `long` | `Method` | `Pdb` | No (PDB) |
| `InitializeView` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetThreadInformation` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `UpdateViewState` | `void` | `Method` | `Pdb` | No (PDB) |
| `CloseApplicationWindows` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `LocalizeView<struct Windows::ApplicationModel::Core::ICoreApplicationView>` | `long` | `Method` | `Pdb` | No (PDB) |
| `LocalizeView<struct Windows::ApplicationModel::Core::ICoreApplicationViewInternal>` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `CreateMainView` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetActiveWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `InitializeWithCurrentCoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `CloseWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `UninitializeView` | `long` | `Method` | `Pdb` | No (PDB) |
| `UnblockPsmStateChangeIfSuspendPending` | `void` | `Method` | `Pdb` | No (PDB) |
| `LocalizeView<struct Windows::Foundation::Private::ICoreApplicationViewInternal2>` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `GetApplicationWindowWithViewId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetIids` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `InvokeClosingEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `PostConfigureComponent` | `long` | `Method` | `Pdb` | No (PDB) |
| `PreConfigureComponent` | `long` | `Method` | `Pdb` | No (PDB) |
