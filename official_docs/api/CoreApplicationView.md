...
Reconstructed from `twinapi.appcore.dll`. Total members: **164**.
...
|---|---|---|---|---|
| `CloseNonImmersiveView` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPresentationUnloaded` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPresentationLoading` | `long` | `Method` | `Pdb` | No (PDB) |
| `SuspendResume` | `long` | `Method` | `Pdb` | No (PDB) |
| `Activate` | `long` | `Method` | `Pdb` | No (PDB) |
| `PrepareViewSwitcherForActivation` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetCoreWindowNavigationClient` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `PrepareToActivateAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetWindowAndGetDispatcher` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `RegisterForCoreWindowActivatedEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetApplicationViewClientAdapter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `CreateCoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `ViewExiting` | `bool` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `CoreApplicationView` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `Load` | `long` | `Method` | `Pdb` | No (PDB) |
| `CreateAndInitializeFrameworkView` | `long` | `Method` | `Pdb` | No (PDB) |
| `Uninitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetCoreApplicationViewClientAdapter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `~CoreApplicationView` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `get_Dispatcher` | `long` | `Method` | `Pdb` | No (PDB) |
| `CancelMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnCoreWindowActivated` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetUint64WindowIdFromCoreWindowOrAppWindow` | `uint64_t` | `Accessor` | `Pdb` | No (PDB) |
| `RegisterPresentationEvents` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_CoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `InitializeDispatcher` | `long` | `Method` | `Pdb` | No (PDB) |
| `v_MarshalAdditionalData` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetActiveWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_TitleBar` | `long` | `Method` | `Pdb` | No (PDB) |
| `v_GetAdditionalDataSizeMax` | `long` | `Method` | `Pdb` | No (PDB) |
| `Run` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsComponent` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsMain` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetComponentViewInstanceId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `v_GetHandlerCLSID` | `struct _GUID const &` | `Method` | `Pdb` | No (PDB) |
| `add_Activated` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `CloseWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetAppActivationClientAdapter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_RootLegacyVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_RootVisual` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `add_HostedViewClosing` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_ModeCancelRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsHosted` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Activated` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_HostedViewClosing` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_ModeCancelRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddApplicationWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `ConfigureBridgeVisualForWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `ConfigureComponentInput` | `long` | `Method` | `Pdb` | No (PDB) |
| `ConfigureComponentWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `CreateSharedVisualTarget` | `long` | `Method` | `Pdb` | No (PDB) |
| `Disconnect` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetComponentViewInstanceIdAndDisconnectSiteId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetCrossDeviceCompositionVisualTarget` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetCrossDeviceVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetCrossDeviceVisualTarget` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetSharedVisualTargetBridge` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `OnAppWindowActivated` | `long` | `Method` | `Pdb` | No (PDB) |
| `PreProvideActivatedEventArgs` | `long` | `Method` | `Pdb` | No (PDB) |
| `ReceiveDesignerSharedVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `ReceiveSharedVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `RegisterAppWindowActivationEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveApplicationWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetDefaultTitleBarDragVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetDesignerRootVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `UnregisterAppWindowActivationEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `UnregisterPresentationEvents` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_DispatcherQueue` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_GlobalCompositionDevice` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ViewInstanceId` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_RootLegacyVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_RootVisual` | `long` | `Method` | `Pdb` | No (PDB) |
