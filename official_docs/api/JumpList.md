...
|---|---|---|---|---|
| `Deserialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `Serialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `SaveAsync` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `put_SystemGroupKind` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `get_SystemGroupKind` | `long` | `Method` | `Pdb` | No (PDB) |
| `JumpList` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~JumpList` | `void` | `Dtor` | `Pdb` | No (PDB) |
