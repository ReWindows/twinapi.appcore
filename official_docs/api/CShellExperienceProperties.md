# `global` :: `CShellExperienceProperties`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **63**.
...
| `~CShellExperienceProperties` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `put_FullScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_DesiredSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `CShellExperienceProperties` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetView` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `HasKey` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `get_DesiredSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_FullScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Size` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_MapChanged` | `long` | `Method` | `Pdb` | No (PDB) |
