# `global` :: `CActivatedEventArgsBase`
...
|---|---|---|---|---|
| `CActivatedEventArgsBase` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `MarshalObjectToPropertySet` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `InitializeViewDependent` | `long` | `Method` | `Pdb` | No (PDB) |
| `v_GetActivationKind` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SplashScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `Initialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `~CActivatedEventArgsBase` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `get_User` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Kind` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_PreviousExecutionState` | `long` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `get_ActivationManagerActivityId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ActivationManagerId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ActivationValueSetReference` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsForegroundActivation` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsHolographic` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_UserContext` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ActivationValueSetReference` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_UserContext` | `long` | `Method` | `Pdb` | No (PDB) |
