# `global` :: `CApplicationViewTitleBar`
...
|---|---|---|---|---|
| `~CApplicationViewTitleBar` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `put_BackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonHoverForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonPressedBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonInactiveBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `_SetColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonHoverForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `CApplicationViewTitleBar` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `get_ForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonPressedBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_InactiveForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonInactiveBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_InactiveBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonPressedForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonInactiveForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_BackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonHoverBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ButtonBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `put_ButtonHoverBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `put_ButtonInactiveForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ButtonPressedForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_InactiveBackgroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_InactiveForegroundColor` | `long` | `Method` | `Pdb` | No (PDB) |
