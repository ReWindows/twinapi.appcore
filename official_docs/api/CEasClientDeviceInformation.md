# `Windows::Security::ExchangeActiveSyncProvisioning` :: `CEasClientDeviceInformation`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **34**.
...
| `get_OperatingSystem` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemSku` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemManufacturer` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemProductName` | `long` | `Method` | `Pdb` | No (PDB) |
| `CEasClientDeviceInformation` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `get_FriendlyName` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_Id` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemFirmwareVersion` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemHardwareVersion` | `long` | `Method` | `Pdb` | No (PDB) |
