...
Reconstructed from `twinapi.appcore.dll`. Total members: **54**.
...
|---|---|---|---|---|
| `remove_LayoutMetricsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `CoreApplicationViewTitleBar` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `SetInputSinkWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `add_LayoutMetricsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_SetVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `_CreateInputSink` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetTitleBarVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_NotifyTitleBarVisualUpdate` | `void` | `Method` | `Pdb` | No (PDB) |
| `put_ExtendViewIntoTitleBar` | `long` | `Method` | `Pdb` | No (PDB) |
| `_SetExtendView` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateDefaultTitleBarDragVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `_TryGetTitleBarClientAdapter` | `bool` | `Method` | `Pdb` | No (PDB) |
| `_GetWindowHWND` | `long` | `Method` | `Pdb` | No (PDB) |
| `_UpdateInputSinkForVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_EnsureWindowService` | `int` | `Method` | `Pdb` | No (PDB) |
| `OnLayoutMetricsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `~CoreApplicationViewTitleBar` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `EnsureWindowService` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsVisible` | `long` | `Method` | `Pdb` | No (PDB) |
| `HasTitleBarVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_ExtendViewIntoTitleBar` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `get_Height` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_IsVisibleChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SystemOverlayLeftInset` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `NotifyPersistedValues` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `_TryGetInputRoutingInfoFromTitleBarClientAdapter` | `bool` | `Method` | `Pdb` | No (PDB) |
| `get_SystemOverlayRightInset` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `OnVisibilityChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_NotifyLayoutMetricsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_NotifyVisibilityChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_AreMsgRoutingInfoEqual` | `bool` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `_OnTitleBarClientAdapterInputRoutingInfoChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnTitleBarClientAdapterLayoutMetricsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnTitleBarClientAdapterVisibilityChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_DesiredTitlebarOverlayState` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_DesiredTitlebarOverlayState` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_IsVisibleChanged` | `long` | `Method` | `Pdb` | No (PDB) |
