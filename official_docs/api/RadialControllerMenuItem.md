...
Reconstructed from `twinapi.appcore.dll`. Total members: **42**.
...
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `_InitRadialControllerMenuItemFromFontGlyph` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_Invoked` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_DisplayText` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_FontFamily` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Icon` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_InternalId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_KnownIcon` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_Tag` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Invoked` | `long` | `Method` | `Pdb` | No (PDB) |
