# `Windows::Foundation::Private` :: `ComponentSite`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **64**.
...
| `get_IsValid` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `GetTrustLevel` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `ComponentSite` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~ComponentSite` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `add_ProcessExited` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ComponentPid` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Id` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_InputSite` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_View` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ComponentPid` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_ProcessExited` | `long` | `Method` | `Pdb` | No (PDB) |
| `Close` | `long` | `Method` | `Pdb` | No (PDB) |
| `CloseOrDisconnectHelper` | `long` | `Method` | `Pdb` | No (PDB) |
| `CommitGlobalDCompDevice` | `long` | `Method` | `Pdb` | No (PDB) |
| `ConfigureSiteInput` | `long` | `Method` | `Pdb` | No (PDB) |
| `DisconnectAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetSharedVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `RemoveFromCoreAppMap` | `long` | `Method` | `Pdb` | No (PDB) |
| `RemoveSharedVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetComponentVisualHandle` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetSharedVisual` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `StartMonitoringComponentProcess` | `long` | `Method` | `Pdb` | No (PDB) |
| `StopMonitoringComponentProcess` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ComponentInteropWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ComponentViewInstanceId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_CompositionDevice` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_CoreWindowSite` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_HostInteropWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_HostViewInstanceId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SharedVisual` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ComponentInteropWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ComponentViewInstanceId` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_CompositionDevice` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_HostInteropWindow` | `long` | `Method` | `Pdb` | No (PDB) |
