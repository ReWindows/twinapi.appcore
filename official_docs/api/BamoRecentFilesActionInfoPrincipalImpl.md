# `BamoRecentFilesListener::BamoImpl` :: `BamoRecentFilesActionInfoPrincipalImpl`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **32**.
...
|---|---|---|---|---|
| `GetHolder` | `class Microsoft::Bamo::BamoPrincipal *` | `Accessor` | `Pdb` | No (PDB) |
| `~BamoRecentFilesActionInfoPrincipalImpl` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `AllocateStubUnderLockThunk` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnMessage` | `long` | `Method` | `Pdb` | No (PDB) |
| `PushStateToProxy` | `void` | `Method` | `Pdb` | No (PDB) |
| `PushStateToProxyOnOutboundMessagesResumed` | `void` | `Method` | `Pdb` | No (PDB) |
| `RefreshFileIdentifiers` | `long` | `Method` | `Pdb` | No (PDB) |
| `SendMaterializeProxy` | `void` | `Method` | `Pdb` | No (PDB) |
| `SetContentUri` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetFilePath` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetProcessFilePath` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetShellIdList` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `UpdateActionInvokingProcessIdRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateActionInvokingProcessIdRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateActionRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateActionRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateContentUriRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateContentUriRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateFilePathRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateFilePathRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateObjectIdentifierRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateObjectIdentifierRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateProcessFilePathRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateProcessFilePathRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateRevisionRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateRevisionRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateShellIdListRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateShellIdListRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
| `UpdateVolumeIdentifierRemoteCache` | `void` | `Method` | `Pdb` | No (PDB) |
| `UpdateVolumeIdentifierRemoteCacheStatic` | `long` | `Method` | `Pdb` | No (PDB) |
