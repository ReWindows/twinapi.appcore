# `global` :: `StartupTaskActivatedEventArgsImpl`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **52**.
...
| `StartupTaskActivatedEventArgsImpl` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~StartupTaskActivatedEventArgsImpl` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `get_TaskId` | `long` | `Method` | `Pdb` | No (PDB) |
