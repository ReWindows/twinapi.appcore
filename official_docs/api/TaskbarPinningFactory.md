# `global` :: `TaskbarPinningFactory`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **30**.
...
| `GetPinnedWebsites` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `s_CallBrokerMethod<struct HSTRING__*, struct HSTRING__*, struct HSTRING__* &, struct HSTRING__* &>` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_CallBrokerMethod<struct HSTRING__*, struct HSTRING__*, struct HSTRING__*, struct HSTRING__*>` | `long` | `Method` | `Pdb` | No (PDB) |
| `TaskbarPinningFactory` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `FallbackMigratePinnedWebsite` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetIids` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetIids` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `PinWebsite` | `long` | `Method` | `Pdb` | No (PDB) |
| `PinWebsiteAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `PrepareMigratePinnedWebsite` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `UnpinWebsiteAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_PinWebsiteBackgroundThread` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_UnpinWebsiteBackgroundThread` | `long` | `Method` | `Pdb` | No (PDB) |
