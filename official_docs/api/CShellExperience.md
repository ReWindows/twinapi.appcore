# `global` :: `CShellExperience`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **36**.
...
|---|---|---|---|---|
| `QueueEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `_NotifyQueueEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GetShellExperienceBroker` | `long` | `Method` | `Pdb` | No (PDB) |
| `_GetBrokerWorker<struct IImmersiveShellBroker, struct IShellExperienceBroker>` | `long` | `Method` | `Pdb` | No (PDB) |
| `RaiseReactivatedEvent` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetExperienceId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SerializeStringToBuffer` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `AllowSetForeground` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetRuntimeClassName` | `unsigned short const *` | `Method` | `Pdb` | No (PDB) |
| `UpdateProperties` | `long` | `Method` | `Pdb` | No (PDB) |
| `_NotifyShellExperienceManager` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `add_Reactivated` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `put_Properties` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `put_ExperienceID` | `long` | `Method` | `Pdb` | No (PDB) |
| `~CShellExperience` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `get_ExperienceID` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `remove_Reactivated` | `long` | `Method` | `Pdb` | No (PDB) |
