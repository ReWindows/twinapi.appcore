...
Reconstructed from `twinapi.appcore.dll`. Total members: **37**.
...
|---|---|---|---|---|
| `_OnMenuItemsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_SendAddedMenuItem` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnMenuItemInvoked` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `get_Items` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `RadialControllerMenu` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~RadialControllerMenu` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `GetSelectedMenuItem` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `SelectMenuItem` | `long` | `Method` | `Pdb` | No (PDB) |
| `TrySelectPreviouslySelectedMenuItem` | `long` | `Method` | `Pdb` | No (PDB) |
| `_RepopulateMenuItems` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_CoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
