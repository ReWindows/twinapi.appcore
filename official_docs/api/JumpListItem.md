...
Reconstructed from `twinapi.appcore.dll`. Total members: **48**.
...
|---|---|---|---|---|
| `Serialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `JumpListItem` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `SetArgumentsInternal` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `put_GroupName` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_Description` | `long` | `Method` | `Pdb` | No (PDB) |
| `ValidateTextFieldLength` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_DisplayName` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Logo` | `long` | `Method` | `Pdb` | No (PDB) |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `put_Logo` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetLogoInternal` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `ValidateLogoPrefix` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `~JumpListItem` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `get_Arguments` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetTrustLevel` | `enum TrustLevel` | `Method` | `Pdb` | Yes |
| `get_DisplayName` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_GroupName` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_RemovedByUser` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Kind` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `ValidateKind` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `SetRemovedByUser` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_Description` | `long` | `Method` | `Pdb` | No (PDB) |
