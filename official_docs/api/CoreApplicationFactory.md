# `Windows::ApplicationModel::Core` :: `CoreApplicationFactory`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **70**.
...
| `DecrementApplicationUseCount` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_LeavingBackground` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_EnteredBackground` | `long` | `Method` | `Pdb` | No (PDB) |
| `CoreApplicationFactory` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `IncrementApplicationUseCount` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `RunDedicatedBackgroundHostWithBackgroundFactoryAndThreadingModel` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `GetSite` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `RunBackgroundHostWithActivationFactoriesAndThreadingModel` | `long` | `Method` | `Pdb` | No (PDB) |
| `RunFrameworkViewSourceWithBackgroundFactoryAndThreadingModel` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetComponentViewInstanceId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetSite` | `long` | `Accessor` | `Pdb` | No (PDB) |
