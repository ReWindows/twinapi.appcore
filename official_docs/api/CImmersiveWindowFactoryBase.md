# `global` :: `CImmersiveWindowFactoryBase`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **21**.
...
|---|---|---|---|---|
| `s_CreateDuplicatingImmersiveWindowFactory` | `long` | `Method` | `Pdb` | No (PDB) |
| `v_Initialize` | `long` | `Method` | `Pdb` | Yes |
| `v_OnAfterSetAppWindow` | `void` | `Method` | `Pdb` | Yes |
| `v_CreateSplashScreen` | `long` | `Method` | `Pdb` | Yes |
| `CreateCoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetAppWindowAndGetHostProcess` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `CImmersiveWindowFactoryBase` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CImmersiveWindowFactoryBase` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `CreateSplashScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetAppWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `HasExistingSplashScreen` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `Initialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `InitializeWithPosition` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetAppWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetViewId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_WindowReuseAllowed` | `long` | `Method` | `Pdb` | No (PDB) |
