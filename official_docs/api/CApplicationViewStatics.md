# `global` :: `CApplicationViewStatics`

**Category:** [Controls & Widgets](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **22**.
...
|---|---|---|---|---|
| `GetForCurrentView` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `CApplicationViewStatics` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `_GetViewStateFromCoreWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_PreferredLaunchWindowingMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetTitleBarClientAdapter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `GetApplicationViewIdForWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `get_Value` | `long` | `Method` | `Pdb` | No (PDB) |
| `ActivateInstance` | `long` | `Method` | `Pdb` | No (PDB) |
| `ClearAllPersistedState` | `long` | `Method` | `Pdb` | No (PDB) |
| `ClearPersistedState` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetPositionerClientAdapter` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `TryUnsnap` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryUnsnapToFullscreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `_ClearPersistedState` | `long` | `Method` | `Pdb` | No (PDB) |
| `_s_GetCoreWindowForCurrentThread` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_PreferredLaunchViewSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_PreferredLaunchWindowingMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_TerminateAppOnFinalViewClose` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_PreferredLaunchViewSize` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_TerminateAppOnFinalViewClose` | `long` | `Method` | `Pdb` | No (PDB) |
