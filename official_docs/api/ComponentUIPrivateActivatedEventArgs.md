# `global` :: `ComponentUIPrivateActivatedEventArgs`
...
|---|---|---|---|---|
| `put_ObjectModelAcidPrivate` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `ComponentUIPrivateActivatedEventArgs` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~ComponentUIPrivateActivatedEventArgs` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `get_ActivationArgs` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ComponentSiteId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ObjectModelAcid` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ObjectModelAcidPrivate` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_PrelaunchActivated` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ComponentSiteId` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
