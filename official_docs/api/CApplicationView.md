# `global` :: `CApplicationView`

**Category:** [Controls & Widgets](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **130**.
...
|---|---|---|---|---|
| `CApplicationView` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryConsolidateAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_Title` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_Consolidated` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ViewMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetDisplayRegions` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `~CApplicationView` | `void` | `Dtor` | `Pdb` | No (PDB) |
| `TryResizeView` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetPreferredMinSize` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `TryEnterFullScreenMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsFullScreenMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_DesiredBoundsMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_VisibleBounds` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetRuntimeClassName` | `unsigned short const *` | `Method` | `Pdb` | No (PDB) |
| `add_VisibleBoundsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_TitleBar` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Id` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetTrustLevel` | `enum TrustLevel` | `Method` | `Pdb` | Yes |
| `get_CriticalInputMismatch` | `long` | `Method` | `Pdb` | Yes |
| `get_TemporaryInputMismatch` | `long` | `Method` | `Pdb` | Yes |
| `put_CriticalInputMismatch` | `long` | `Method` | `Pdb` | Yes |
| `put_TemporaryInputMismatch` | `long` | `Method` | `Pdb` | Yes |
| `_GetAdjacentDisplayEdges` | `void` | `Method` | `Pdb` | No (PDB) |
| `_OnConsolidated` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `ApplyApplicationUserModelID` | `long` | `Method` | `Pdb` | No (PDB) |
| `ExitFullScreenMode` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetSpanningRects` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `IsViewModeSupported` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `SetDesiredBoundsMode` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `ShowStandardSystemOverlays` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryEnterViewModeAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryEnterViewModeWithPreferencesAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryPositionView` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnVisibleBoundsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `_TryEnterViewModeHelperAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_AdjacentToLeftDisplayEdge` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_AdjacentToRightDisplayEdge` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_FullScreenSystemOverlayMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsFullScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsFullScreenModeDisabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsLightweightFullScreenModeAllowed` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsOnLockScreen` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsScreenCaptureEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Orientation` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_PersistedStateId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_SuppressSystemOverlays` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Title` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_UIContext` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_WindowId` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_WindowingEnvironment` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_FullScreenSystemOverlayMode` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsFullScreenModeDisabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsLightweightFullScreenModeAllowed` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsScreenCaptureEnabled` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_PersistedStateId` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_SuppressSystemOverlays` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Consolidated` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_VisibleBoundsChanged` | `long` | `Method` | `Pdb` | No (PDB) |
