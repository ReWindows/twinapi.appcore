# `global` :: `CViewSwitcherStatics`

**Category:** [Controls & Widgets](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **47**.
...
|---|---|---|---|---|
| `DisableSystemViewActivationPolicy` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetRuntimeClassNameStatic` | `unsigned short const *` | `Method` | `Pdb` | No (PDB) |
| `DisableShowingMainViewOnActivation` | `long` | `Method` | `Pdb` | No (PDB) |
| `InternalGetTrustLevelStatic` | `enum TrustLevel` | `Method` | `Pdb` | Yes |
| `GetTrustLevel` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_s_GetCoreWindowForCurrentThread` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `PrepareForCustomAnimatedSwitchAsync` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `SwitchAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `SwitchFromViewAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `SwitchFromViewWithOptionsAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryShowAsStandaloneAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryShowAsStandaloneWithAnchorViewAndSizePreferenceAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryShowAsStandaloneWithSizePreferenceAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryShowAsViewModeAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `TryShowAsViewModeWithPreferencesAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `_ShowViewAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `_SwitchViewsAsync` | `long` | `Method` | `Pdb` | No (PDB) |
| `_s_TransformIfErrorAndOriginateError` | `void` | `Method` | `Pdb` | No (PDB) |
