# `Windows::ApplicationModel::Core` :: `ApplicationActivationFactory`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **55**.
...
| `GetActivationFactory` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `ApplicationActivationFactory` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `~ApplicationActivationFactory` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `GetTrustLevel` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `add_FinalUnhandledErrorDetected` | `long` | `Method` | `Pdb` | Yes |
| `remove_FinalUnhandledErrorDetected` | `long` | `Method` | `Pdb` | Yes |
| `GetTrustLevel` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetTrustLevel` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
