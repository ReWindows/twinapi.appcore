...
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `CEdgeGesture` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CEdgeGesture` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `Canceled` | `long` | `Method` | `Pdb` | No (PDB) |
| `Completed` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `Starting` | `long` | `Method` | `Pdb` | No (PDB) |
| `_CanFireEvent` | `bool` | `Method` | `Pdb` | No (PDB) |
| `_OnContextMenuRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_Canceled` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_Completed` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_Starting` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Canceled` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Completed` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_Starting` | `long` | `Method` | `Pdb` | No (PDB) |
