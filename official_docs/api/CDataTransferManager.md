# `global` :: `CDataTransferManager`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **45**.
...
|---|---|---|---|---|
| `add_DataRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnExperienceCallback` | `long` | `Method` | `Pdb` | Yes |
...
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `CDataTransferManager` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CDataTransferManager` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `[thunk]: public: virtual void *` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `FireSharingContentRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `FireSharingProvidersRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `FireTargetApplicationActivated` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `InvokeFlow` | `long` | `Method` | `Pdb` | No (PDB) |
| `InvokeFlowForAppId` | `long` | `Method` | `Pdb` | No (PDB) |
| `InvokeFlowWithOptions` | `long` | `Method` | `Pdb` | No (PDB) |
| `InvokeShareProviderHandler` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `RegisterProxyWindowCleanupHandlers` | `void` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `SetSharingInProgress` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `ShowShareUIFromRemoteDataTransferManager` | `long` | `Method` | `Pdb` | No (PDB) |
| `_CheckPendingShareFlow` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_ShareProvidersRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `add_TargetApplicationChosen` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_DataRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_ShareProvidersRequested` | `long` | `Method` | `Pdb` | No (PDB) |
| `remove_TargetApplicationChosen` | `long` | `Method` | `Pdb` | No (PDB) |
