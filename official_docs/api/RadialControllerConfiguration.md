...
Reconstructed from `twinapi.appcore.dll`. Total members: **40**.
...
| `AddRef` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `RadialControllerConfiguration` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~RadialControllerConfiguration` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `QueryInterface` | `[thunk]: public: virtual long` | `Refcount` | `Pdb` | No (PDB) |
| `RefreshConnectionToShell` | `long` | `Method` | `Pdb` | No (PDB) |
| `Release` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `ResetToDefaultMenuItems` | `long` | `Method` | `Pdb` | No (PDB) |
| `RuntimeClassInitialize` | `long` | `Method` | `Pdb` | No (PDB) |
| `SetDefaultMenuItems` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `TrySelectDefaultMenuItem` | `long` | `Method` | `Pdb` | No (PDB) |
| `_OnMenuSuppressStateChanged` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_ActiveControllerWhenMenuIsSuppressed` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_IsMenuSuppressed` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_ActiveControllerWhenMenuIsSuppressed` | `long` | `Method` | `Pdb` | No (PDB) |
| `put_IsMenuSuppressed` | `long` | `Method` | `Pdb` | No (PDB) |
