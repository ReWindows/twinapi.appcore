# `BamoRecentFilesListener` :: `BamoRecentFilesActionInfoProxy`

**Category:** [Accessibility & UIA Providers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **38**.
...
|---|---|---|---|---|
| `OnActionChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnActionChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnActionInvokingProcessIdChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnActionInvokingProcessIdChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnContentUriChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnContentUriChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnFilePathChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnFilePathChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnObjectIdentifierChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnObjectIdentifierChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnProcessFilePathChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnProcessFilePathChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnRevisionChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnRevisionChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnShellIdListChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnShellIdListChanging` | `long` | `Method` | `Pdb` | Yes |
| `OnVolumeIdentifierChanged` | `long` | `Method` | `Pdb` | Yes |
| `OnVolumeIdentifierChanging` | `long` | `Method` | `Pdb` | Yes |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetImpl` | `class Microsoft::BamoImpl::BamoProxyImpl *` | `Accessor` | `Pdb` | No (PDB) |
...
| `OnConnectedCallout` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnDisconnectedCallout` | `long` | `Method` | `Pdb` | No (PDB) |
| `OnPropertiesRefreshedCallout` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetAction` | `enum winrt::Windows::Internal::UI::StartScreen::RecentFilesAction` | `Accessor` | `Pdb` | No (PDB) |
| `GetActionInvokingProcessId` | `unsigned int` | `Accessor` | `Pdb` | No (PDB) |
| `GetContentUri` | `unsigned short const *` | `Accessor` | `Pdb` | No (PDB) |
| `GetFilePath` | `unsigned short const *` | `Accessor` | `Pdb` | No (PDB) |
| `GetObjectIdentifier` | `struct _GUID const &` | `Accessor` | `Pdb` | No (PDB) |
| `GetProcessFilePath` | `unsigned short const *` | `Accessor` | `Pdb` | No (PDB) |
| `GetRevision` | `uint64_t` | `Accessor` | `Pdb` | No (PDB) |
| `GetShellIdList` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `GetVolumeIdentifier` | `struct _GUID const &` | `Accessor` | `Pdb` | No (PDB) |
