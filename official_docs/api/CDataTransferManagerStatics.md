# `global` :: `CDataTransferManagerStatics`
...
| `CDataTransferManagerStatics` | `void` | `Ctor` | `Pdb` | No (PDB) |
...
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `~CDataTransferManagerStatics` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `GetForWindow` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `GetIids` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `GetRuntimeClassName` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `IsSupported` | `long` | `Accessor` | `Pdb` | No (PDB) |
...
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `Release` | `[thunk]: public: virtual unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `ShareToAppExperience` | `long` | `Method` | `Pdb` | No (PDB) |
| `ShowShareUI` | `long` | `Method` | `Pdb` | No (PDB) |
| `ShowShareUIForWindow` | `long` | `Method` | `Pdb` | No (PDB) |
| `ShowShareUIWithOptions` | `long` | `Method` | `Pdb` | No (PDB) |
| `s_CreateDataTransferManagerForHwnd` | `long` | `Method` | `Pdb` | No (PDB) |
