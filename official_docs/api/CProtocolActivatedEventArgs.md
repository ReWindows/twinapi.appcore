# `global` :: `CProtocolActivatedEventArgs`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **87**.
...
| `~CProtocolActivatedEventArgs` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `get_CallerPackageFamilyName` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Uri` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_Data` | `long` | `Method` | `Pdb` | No (PDB) |
| `CProtocolActivatedEventArgs` | `void` | `Ctor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `[thunk]: private: virtual void *` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `[thunk]: private: virtual void *` | `Dtor` | `Pdb` | No (PDB) |
