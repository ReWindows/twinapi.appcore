# `global` :: `CPackageDebugSettings`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **39**.
...
|---|---|---|---|---|
| `GetPackageExecutionState` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `_GetInternalDebugControl` | `long` | `Method` | `Pdb` | No (PDB) |
| `_EnsureDebugControlCreatedAndRegisteredInGIT` | `long` | `Method` | `Pdb` | No (PDB) |
| `CPackageDebugSettings` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CPackageDebugSettings` | `void` | `Dtor` | `Pdb` | No (PDB) |
| ``vector deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| ``scalar deleting destructor'` | `void *` | `Dtor` | `Pdb` | No (PDB) |
| `ActivateBackgroundTask` | `long` | `Method` | `Pdb` | No (PDB) |
| `ActivateBackgroundTask` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `DisableDebugging` | `long` | `Method` | `Pdb` | No (PDB) |
| `DisableDebugging` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `EnableDebugging` | `long` | `Method` | `Pdb` | No (PDB) |
| `EnableDebugging` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `EnumerateApps` | `long` | `Method` | `Pdb` | No (PDB) |
| `EnumerateBackgroundTasks` | `long` | `Method` | `Pdb` | No (PDB) |
| `EnumerateBackgroundTasks` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `GetPackageExecutionState` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `RegisterForPackageStateChanges` | `long` | `Method` | `Pdb` | No (PDB) |
| `RegisterForPackageStateChanges` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `Resume` | `long` | `Method` | `Pdb` | No (PDB) |
| `Resume` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `SetTargetSessionId` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetTargetSessionId` | `[thunk]: public: virtual long` | `Accessor` | `Pdb` | No (PDB) |
| `StartServicing` | `long` | `Method` | `Pdb` | No (PDB) |
| `StartServicing` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `StartSessionRedirection` | `long` | `Method` | `Pdb` | No (PDB) |
| `StartSessionRedirection` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `StopServicing` | `long` | `Method` | `Pdb` | No (PDB) |
| `StopServicing` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `StopSessionRedirection` | `long` | `Method` | `Pdb` | No (PDB) |
| `StopSessionRedirection` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `Suspend` | `long` | `Method` | `Pdb` | No (PDB) |
| `Suspend` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `TerminateAllProcesses` | `long` | `Method` | `Pdb` | No (PDB) |
| `TerminateAllProcesses` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `UnregisterForPackageStateChanges` | `long` | `Method` | `Pdb` | No (PDB) |
| `UnregisterForPackageStateChanges` | `[thunk]: public: virtual long` | `Method` | `Pdb` | No (PDB) |
| `_GetBrokerFromShellServiceHost` | `long` | `Method` | `Pdb` | No (PDB) |
| `_RemoveObjectsFromGIT` | `void` | `Method` | `Pdb` | No (PDB) |
