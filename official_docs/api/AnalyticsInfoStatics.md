# `Windows::System::Profile` :: `AnalyticsInfoStatics`

**Category:** [Utilities & Helpers](./README.md)

Reconstructed from `twinapi.appcore.dll`. Total members: **35**.
...
| `QueryDeviceFamilyVersion` | `long` | `Method` | `Pdb` | No (PDB) |
| `AnalyticsInfoStatics` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `QueryDeviceFamilyAndDeviceForm` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryProductName` | `long` | `Method` | `Pdb` | No (PDB) |
| `get_VersionInfo` | `long` | `Method` | `Pdb` | No (PDB) |
| `QueryInterface` | `long` | `Refcount` | `Pdb` | No (PDB) |
| `_GetSystemProperties` | `long` | `Method` | `Pdb` | No (PDB) |
| `GetSystemPropertiesAsync` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `get_DeviceForm` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `~AnalyticsInfoStatics` | `void` | `Dtor` | `Pdb` | No (PDB) |
