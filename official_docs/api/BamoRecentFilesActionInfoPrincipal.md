# `BamoRecentFilesListener` :: `BamoRecentFilesActionInfoPrincipal`
...
|---|---|---|---|---|
| `InitializeProxyUnderLock` | `long` | `Method` | `Pdb` | Yes |
| `OnPropertiesRefreshed` | `long` | `Method` | `Pdb` | Yes |
| `OnStubConnectedUnderLock` | `long` | `Method` | `Pdb` | Yes |
| `OnStubDisconnected` | `long` | `Method` | `Pdb` | Yes |
| `AddRef` | `unsigned long` | `Refcount` | `Pdb` | No (PDB) |
| `GetImpl` | `class Microsoft::BamoImpl::BamoPrincipalImpl *` | `Accessor` | `Pdb` | No (PDB) |
...
| `AllocateStubUnderLock` | `long` | `Method` | `Pdb` | No (PDB) |
...
| `SetAction` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetActionInvokingProcessId` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetContentUri` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetFilePath` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetObjectIdentifier` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetProcessFilePath` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetRevision` | `void` | `Accessor` | `Pdb` | No (PDB) |
| `SetShellIdList` | `long` | `Accessor` | `Pdb` | No (PDB) |
| `SetVolumeIdentifier` | `void` | `Accessor` | `Pdb` | No (PDB) |
