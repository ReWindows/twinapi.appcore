# `global` :: `CommandLineActivatedEventArgsImpl`
...
| `CommandLineActivatedEventArgsImpl` | `void` | `Ctor` | `Pdb` | No (PDB) |
| `~CommandLineActivatedEventArgsImpl` | `void` | `Dtor` | `Pdb` | No (PDB) |
...
| `get_Operation` | `long` | `Method` | `Pdb` | No (PDB) |
